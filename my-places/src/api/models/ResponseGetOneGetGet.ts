 ...
 * 
 * @export
 * @interface ResponseGetOneGetGet
 */
export interface ResponseGetOneGetGet {
    /**
     * 
     * @type {Id}
     * @memberof ResponseGetOneGetGet
     */
    id?: Id;
    /**
     * 
...
/**
 * Check if a given object implements the ResponseGetOneGetGet interface.
 */
export function instanceOfResponseGetOneGetGet(value: object): boolean {
    let isInstance = true;
...
export function ResponseGetOneGetGetFromJSON(json: any): ResponseGetOneGetGet {
    return ResponseGetOneGetGetFromJSONTyped(json, false);
}

export function ResponseGetOneGetGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseGetOneGetGet {
...
export function ResponseGetOneGetGetToJSON(value?: ResponseGetOneGetGet | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
